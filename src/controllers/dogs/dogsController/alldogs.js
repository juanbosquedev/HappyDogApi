...
module.exports = async (req, res) => {
  try {
    const dogsWithOwners = await DogsRecord.findAll({
      include: {
        model: User,
    ...
    return res.status(200).json(dogsWithOwners);
  } catch (error) {
...
// const { User, DogsRecord } = require("../../../models/index.js");
// // const { fetchDogsData } = require("../../utils/fill-database/fill-dogs/getDogData/getDogData.js");
...
//     return res.status(200).json(usersWithDogs);
//   } catch (error) {
